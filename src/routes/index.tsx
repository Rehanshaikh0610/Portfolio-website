...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Rehan Shaikh — Full-Stack Developer & Cloud/DevOps" },
      { name: "description", content: "Portfolio of Rehan Shaikh — full-stack developer, DevOps and cloud engineer building beautiful, performant software." },
      { property: "og:title", content: "Rehan Shaikh — Portfolio" },
      { property: "og:description", content: "Explore an interactive developer portfolio: projects, skills, experience and certifications." },
    ],
  }),
  component: HomePage,
});
